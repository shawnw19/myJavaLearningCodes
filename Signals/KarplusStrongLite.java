...
and Digital Signals Processing (Coursera) 1.3.b The Karplus-Strong algorithm
 */
public class KarplusStrongLite {
    ...
    static void RisingPitch(int num,boolean att){//flag of attenuation
        int octaves;
        for (octaves=0;octaves<=num;octaves++){
            double hz = 440 * Math.pow(2, octaves / 12.0);
